          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-300">
                ...
                <li><b>For demo/local use, your data is stored only in memory and is deleted when the server restarts.</b></li>
              </ul>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-300">
                <li>Data encryption in transit (SSL/TLS) and at rest (AES-256) <span className="italic">(for production use)</span></li>
                <li>Secure database storage with restricted access <span className="italic">(for production use)</span></li>
                <li>Regular security audits and vulnerability testing <span className="italic">(for production use)</span></li>
                <li>Google OAuth 2.0 for calendar access with limited scope permissions</li>
                <li><b>For demo/local use, data is stored only in server memory and is not persisted.</b></li>
              </ul>
            </div>
